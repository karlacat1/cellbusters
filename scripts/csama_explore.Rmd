...
```{r}
path2obj <- function(path_csv_gz, data_name){
...
```{r}
cell_exon   = path2obj('data/GSE123454_cells_exon_counts.csv.gz',   "cell_exon")
cell_intron = path2obj('data/GSE123454_cells_intron_counts.csv.gz', "cell_intron")

nuc_exon   = path2obj('data/GSE123454_nuclei_exon_counts.csv.gz',   "nuc_exon")
nuc_intron = path2obj('data/GSE123454_nuclei_intron_counts.csv.gz', "nuc_exon")
```
